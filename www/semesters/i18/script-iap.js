...
function select_slots() {
    ...
    localStorage.setObj('iap18_cur_classes', cur_classes);
...
function set_option(index) {
    ...
    localStorage.setObj('iap18_cur_option', cur_option);
}
...
function set_activity(name, slots, hours) {
    ...
    localStorage.setObj('iap18_activities', activities);
}
...
$(document).ready(function () {
		...
		for (var l in classes[cur_class]['lr']) {
		    ...
		    (function () {
				...
				$("#lec-" + tmp).click(function () {
			   		...
			   		localStorage.setObj('iap18_locked_slots', locked_slots);
			    	select_slots();
				});
		    })();
		}
    ...
    var tmp_cur_classes = localStorage.getObj('iap18_cur_classes');
    var tmp_activities = localStorage.getObj('iap18_activities');
    ...
    var tmp_locked_slots = localStorage.getObj('iap18_locked_slots');
    ...
    var tmp_cur_option = parseInt(localStorage.getObj('iap18_cur_option'));
