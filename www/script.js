...
function select_slots() {
	...
	localStorage.setObj('fall20_cur_classes', cur_classes);
...
function set_activity(name, slots, slots_raw, hours) {
	...
	localStorage.setObj('fall20_activities', activities);
}
...
$(document).ready(function () {
	...
	*/	
				...
				for (var l in classes[cur_class]['lr']) {
					...
					(function () {
						...
						$("#lec-" + tmp).click(function () {
							...
							localStorage.setObj('fall20_locked_slots', locked_slots);
							select_slots();
						});
					})();
				}
	...
	var tmp_cur_classes = localStorage.getObj('fall20_cur_classes');
	var tmp_activities = localStorage.getObj('fall20_activities');
	...
	var tmp_locked_slots = localStorage.getObj('fall20_locked_slots');
	...
	var tmp_cur_option = parseInt(localStorage.getObj('fall20_cur_option'));
